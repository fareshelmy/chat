...
//Notes add by us ^_^
import org.apache.commons.io.FilenameUtils; // from commons-io-2.4
import org.apache.http.HttpResponse; //fluent-hc-4.4-beta1
import org.apache.http.NameValuePair; //fluent-hc-4.4-beta1
import org.apache.http.client.ClientProtocolException; //fluent-hc-4.4-beta1
import org.apache.http.client.fluent.Request; //fluent-hc-4.4-beta1
import org.apache.http.client.utils.URLEncodedUtils; //fluent-hc-4.4-beta1
import org.apache.http.message.BasicNameValuePair;//fluent-hc-4.4-beta1
import org.json.JSONArray; //json-20090211
import org.json.JSONException; //json-20090211
import org.json.JSONObject; //json-20090211
 ...
 * Edited by Aadish Joshi on 5/30/2018 See:
 * <a href="https://developer.pandorabots.com/docs">Pandorabots API
 * Documentation</a><br>
 * </p>
 *
...
public class PandorabotsAPI {
     ...
     * Constructor.
     *
     * @param host host name of pandrabots API server
     * @param appId app_id to pandrabots API
     * @param userKey user_key to pandrabots API
...
//	
     ...
     *
     * @param mode bot or talk or atalk
     ...
     *
     * @param botName name of bot
     * @param pathName path for upload file
     * @return status of response
     * @throws IOException
     * @throws ClientProtocolException
     * @throws URISyntaxException
     ...
     * @param clientName name of client
     * @param input text for conversation
     * @param extra boolean for conversation
     * @param recent = true boolean for conversation
     * @return text of bot's response
     * @see #debugBot(String, String, String, boolean, boolean, boolean,
     * boolean, boolean)
     * @since 1.0.1
     ...
     * @param input text for conversation
     * @param extra adds extra information into response
     * @param reset reset status of bot
     * @param trace adds trace data into response
     * @param reload force system to reload bot
     * @param recent use recent pod even if it is older than files
     * @return text of bot's response
...
//			System.out.println("SessionId:"+sessionId);
    ...
    /**
     * Most general version of anonymous talk method that returns detailed
